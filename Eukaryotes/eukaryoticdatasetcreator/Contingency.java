...
public class Contingency {
   ...
   void createGOCog(OGGOMapping map){
   ...
   void initializeContingency(OGGOMapping map){
    ...
    void initializeContingencyPairs(OGGOMapping map, ArrayList<Pair<String,String>> GOPairs){
     ...
     void initializeContingency(OGGOMapping map, String COG){
     ...
     void initializeContingency(OGGOMapping map, ArrayList<String> COGs, ArrayList<HashSet<String>> categories){
     ...
     void initializeContingency(OGGOMapping map, String COG, ArrayList<HashSet<String>> categories){
   ...
   void addContingency(GeneNeighbours sim, OGGOMapping cgmap, HashMap<String,HashSet<Pair<String,String>>> geneOGMap, int taxid, HashMap<Integer,Integer> taxTranslation){
       ...
       double percent=0.0; 
         long startTime = System.currentTimeMillis();      
          while(keySetIterator.hasNext()){
            ...
            HashSet<String> OGs = null;//geneOGMap.get(key.getValue2());
            
             HashSet<Pair<String,String>> ogs = geneOGMap.get(key.getValue2());
             //System.out.println("Gene mapped to "+ogs.size()+" ogs.");
             
                      
                      HashSet<String> ogsg = new HashSet<>();
                      
                      for(Pair<String,String> p:ogs){
                         // System.out.println("OG: "+p.getValue0()+" "+p.getValue1());
                      ...
                      OGs = ogsg;
                     // System.out.println("From these: "+OGs.size()+" blong to this organism");
        ...
        for(String s:cogsGOs)
            if(cgmap.GOtoIndex.containsKey(s))
                cogsGOsSet.add(cgmap.GOtoIndex.get(s));
        }
        
       // System.out.println("OGs belonging to a gene contain in total: "+cogsGOsSet.size()+" functions");
        ...
        for(int i=0;i<value.size();i++){
            ...
            HashSet<String> OGsN=null;
            
             HashSet<Pair<String,String>> ogs1 = geneOGMap.get(value.get(i).getValue2());
             HashSet<String> ogsg1 = new HashSet<>();
                      
                      for(Pair<String,String> p:ogs1)
                          if(Integer.parseInt(p.getValue1())==taxid || taxTranslation.get(Integer.parseInt(p.getValue1())).equals(taxTranslation.get(taxid)))
                                 ogsg1.add(p.getValue0());
            
                      OGsN = ogsg1;
            
           // System.out.println("Neighbourhood contains "+OGsN.size()+" ogs belonging to this organism");
        ...
        for(int j=0;j<value1.size();j++){
            ...
            if(cgmap.GOtoIndex.containsKey(value1.get(j)))
      ...
      // }
       ...
       // System.out.println("Neighbourhood ogs contain: "+neighbGOs.size()+" functions");
       ...
       // System.out.println("Table: "+cgmap.IndexToGO.get(2));
        /*for(int zn=0;zn<4;zn++){
            if(zn%2==1)
                 System.out.print(contTable.get(2).get(2).get(0)+" "+contTable.get(2).get(2).get(zn)+"\n");
            else
                 System.out.print(contTable.get(2).get(2).get(0)+" "+contTable.get(2).get(2).get(zn));
   ...
   void addContingency1(GeneNeighbours sim, OGGOMapping cgmap, HashMap<String,HashSet<Pair<String,String>>> geneOGMap, int taxid, HashMap<Integer,Integer> taxTranslation){
      ...
      // }
        ...
        for(Integer cg:cgmap.IndexToGO.keySet()){
            for(Integer cg1:cgmap.IndexToGO.keySet()){
            if(cogsGOsSet.contains(cg) && neighbGOs.contains(cg1)){
                   int val=contTable.get(/*cgmap.GOtoIndex.get(cg)*/ cg).get(cg1/*cgmap.GOtoIndex.get(cg1)*/).get(0);
                   val=val+1;
                   contTable.get(cg/*cgmap.GOtoIndex.get(cg)*/).get(cg1/*cgmap.GOtoIndex.get(cg1)*/).set(0,val);
            }
            else if(!cogsGOsSet.contains(cg) || !neighbGOs.contains(cg1)){
                int val=contTable.get(cg/*cgmap.GOtoIndex.get(cg)*/).get(cg1/*cgmap.GOtoIndex.get(cg1)*/).get(1);       
                val = val+1;
                contTable.get(cg/*cgmap.GOtoIndex.get(cg)*/).get(cg1/*cgmap.GOtoIndex.get(cg1)*/).set(1,val); 
            }
            if(!cogsGOsSet.contains(cg1) && !neighbGOs.contains(cg)){
                 int val=contTable.get(/*cgmap.GOtoIndex.get(cg)*/cg).get(/*cgmap.GOtoIndex.get(cg1)*/cg1).get(2);
                   val=val+1;
                   contTable.get(/*cgmap.GOtoIndex.get(cg)*/cg).get(/*cgmap.GOtoIndex.get(cg1)*/cg1).set(2,val);
            }
            else if(cogsGOsSet.contains(cg1) || neighbGOs.contains(cg)){
                 int val=contTable.get(/*cgmap.GOtoIndex.get(cg)*/cg).get(/*cgmap.GOtoIndex.get(cg1)*/cg1).get(3);
                   val=val+1;
                   contTable.get(/*cgmap.GOtoIndex.get(cg)*/cg).get(/*cgmap.GOtoIndex.get(cg1)*/cg1).set(3,val);
            }
    ...
    void addContingency2(GeneNeighbours sim, OGGOMapping cgmap, HashMap<String,HashSet<Pair<String,String>>> geneOGMap, int taxid, HashMap<Integer,Integer> taxTranslation){
    ...
    void addContingency(GeneNeighbours sim, OGGOMapping cgmap, String GOIn){
     ...
     void addContingency(GeneNeighbours sim, OGGOMapping cgmap, String GOIn, ArrayList<HashSet<String>> categories){
     ...
     void addContingency(GeneNeighbours sim, OGGOMapping cgmap, ArrayList<String> GOs, ArrayList<HashSet<String>> categories){
    ...
    void addContingencyRandom(GeneNeighbours sim, OGGOMapping cgmap, ArrayList<Pair<String,String>> GOPairs){
   ...
   void writeContingency(OGGOMapping map, String outPath){
   ...
   void writeContingency(OGGOMapping map, ArrayList<String> GOs ,String outPath){
