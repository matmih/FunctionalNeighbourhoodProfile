 ...
 * @author Matej Mihelcic
  ...
  *@description class to export LORs. LORs with 0 OR are discarded since continuity correction in such cases produces artefacts.
 */
public class ExportLORNorm {
    public static void main(String []arg){
         ...
         String redGO="GORed5.txt"; String redCog="COGRed150.txt";
    ...
    rgt.translate(extendedGOs);
     ...
     int randStats = 0;
      ...
      FileWriter fw1 = null;
           ...
           try{  
                    fw = new FileWriter(name.split("\\.")[0]+"Norm.txt");
                    fw1 = new FileWriter(name.split("\\.")[0]+"RandNorm.txt");
           }
           catch(IOException e){
               e.printStackTrace();
           }
